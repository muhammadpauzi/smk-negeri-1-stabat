		...
		<div class="col-md-3">
			<div class="card p-3">
				...
				<div class="row">
					<div class="w-100">
						@can('update', $slide)
						<a class="w-100 btn btn-primary mb-2" href="{{ route('dashboard.slides.edit', ['slide' => $slide->slug]) }}">
							<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
								<path stroke="none" d="M0 0h24v24H0z" fill="none" />
						...
						@can('delete', $slide)
						<form action="{{ route('dashboard.slides.destroy', ['slide' => $slide->slug]) }}" method="post" class="w-100 block">
							@csrf
							@method('DELETE')
