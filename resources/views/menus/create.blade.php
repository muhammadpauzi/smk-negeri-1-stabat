                ...
                <div class="col-md-6">
                    <div class="card mb-2">
                        <div class="card-header">
                            <h4 class="card-title">Form Create Menu</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name" autocomplete="menu-name" value="{{ old('name') }}">
                                        @error('name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="icon" class="form-control" name="icon" rows="6" placeholder="Icon of menu (SVG HTML Element)..">{{ old('icon') }}</textarea>
                                        @error('icon')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
